package vnext.com.openvidu.managers;
...
import vnext.com.openvidu.observers.CustomPeerConnectionObserver;
import vnext.com.openvidu.observers.CustomSdpObserver;
...
//        PeerConnectionFactory.initializeAndroidGlobals(activity, true);
    ...
    private void createLocalPeerConnection(MediaConstraints sdpConstraints) {
        final List<PeerConnection.IceServer> iceServers = new ArrayList<PeerConnection.IceServer>();
        ...
        localPeer = peerConnectionFactory.createPeerConnection(iceServers, sdpConstraints, new CustomPeerConnectionObserver("localPeerCreation") {
            ...
            public void onIceCandidate(IceCandidate iceCandidate) {
                ...
                Map<String, String> iceCandidateParams = new HashMap<String, String>();
    ...
    public void createLocalOffer(MediaConstraints sdpConstraints) {
        ...
        localPeer.createOffer(new CustomSdpObserver("localCreateOffer") {
            ...
            public void onCreateSuccess(SessionDescription sessionDescription) {
                ...
                Map<String, String> localOfferParams = new HashMap<String, String>();
